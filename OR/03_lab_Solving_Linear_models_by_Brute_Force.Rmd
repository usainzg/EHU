...
all.basic_solutions_for <- function(A, b){
  ...
  # this generates a matrix with colums for each combination.
...
print(basic.solution(A, b, c(1, 2, 3)))
print(basic.solution(A, b, c(1, 2, 4)))
print(basic.solution(A, b, c(1, 2, 5)))
print(basic.solution(A, b, c(1, 3, 4)))
print(basic.solution(A, b, c(1, 3, 5)))
print(basic.solution(A, b, c(1, 4, 5)))
print(basic.solution(A, b, c(2, 3, 4)))
print(basic.solution(A, b, c(2, 3, 5)))
print(basic.solution(A, b, c(2, 4, 5)))
print(basic.solution(A, b, c(3, 4, 5)))
```
...
print(all.basic_solutions_for(A, b))
```
...
```{r, eval=FALSE}
# Implement here (1 line)
print(all.basic_solutions_apply(A, b))
```
...
```{r, eval=FALSE}
# Implement here (1 line)
print(basic.feasible.solutions_for(A, b))
```
