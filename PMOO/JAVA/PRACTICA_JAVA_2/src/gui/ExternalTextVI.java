...
public class ExternalTextVI {
    ...
    final static String MESSAGE_NOTICE = "NOTA. Para eliminar o actualizar la cantidad de un producto, sit�ese con el rat�n sobre dicho producto, pulse el bot�n derecho y seleccione funcionalidad ";//Oharra: Hautatutako produktua ezabatzeko edo kopurua eguneratzeko jo testuinguruko menura saguaren botoi lagungarria (eskuina, normalean) sakatuz.";


    //METHODS
    public static String methodProductAmountUpdate(int kodea, int oraingoKop) {
        return "Indique en el cuadro inferior la cantidad del producto de c�digo " + kodea + " (actualmente hay " + oraingoKop + " unidades).";
		/*"Sartu hemen behean " + 
				kodea + 
    ...
    public static String methodProductAmountError(int kodea, int oraingoKop) {
        return "La cantidad debe ser un valor num�rico entero; int�ntelo de nuevo (c�digo de producto: " +
                kodea +
                "; cantidad actual: " +
                oraingoKop
                + ")!";
    ...
    public static String methodProductAmountUpdated(int kodea, int oraingoKop) {
        return "Se ha actualizado la cantidad del producto de c�digo " +
