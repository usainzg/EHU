 ...
 *
 */
public class StackOfCharacter {
	private Character[] s; // array para almacenar los elementos de la pila
	private int n; // cantidad de elementos en la pila

	public StackOfCharacter(int capacity) {
		s = new Character[capacity]; // Se crea un array para albergar hasta "capacity" caracteres
		n = 0;
	}
